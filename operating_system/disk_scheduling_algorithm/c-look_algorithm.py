class CLookAlgorithm:
    ...
    def cLookDiskSchedulingAlgorithm(self):
        """Main c-look scheduling algorithm calculation function"""
        ...
        while True:
            ...
            if (self.direction.lower())[0] == "r":
                ...
                for i in range(1, pointer_index):
                    number = self.request_queue[i]
                    local_array.append(number)
                    if len(local_array) == 2:
                        difference = abs(local_array[0] - local_array[1])
    ...
    def main(self):
        """Calling function"""
        self.cLookDiskSchedulingAlgorithm()
