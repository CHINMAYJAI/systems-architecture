class ScanAlgorithm :
    """It is also known as elevator algorithm, and it is the part of disk scheduling algorithm"""
    def __init__(self):
    ...
    def scanSchedulingAlgorithm(self):
...
if __name__ == "__main__" :
    # class object
    scan_algo = ScanAlgorithm()
    # displaying the seek time
    print(f"Seek time: {scan_algo.main()}")